# Generated by Django 3.2 on 2023-06-02 16:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.PositiveSmallIntegerField(blank=True, null=True, validators=[reviews.validators.validate_max_min], verbose_name='Рейтинг произведения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('score', models.IntegerField(default=0, validators=[reviews.validators.validate_max_min])),
